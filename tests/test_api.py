...
class APITestCase(unittest.TestCase):
    ...
    def test_posts(self):
        ...
        r = Role.query.filter_by(name='User').first()
        self.assertIsNotNone(r)
        u = User(email='shenjiayu@qq.com', password='cat', confirmed=True, role=r)
        db.session.add(u)
        db.session.commit()

        # write a post
        response = self.client.post(url_for('api.new_post'), headers=self.
                                    get_api_headers('shenjiayu@qq.com', 'cat'),
        ...
        # get the new post
        response = self.client.get(url, headers=self.get_api_headers('shenjiayu@qq.com', 'cat'))
